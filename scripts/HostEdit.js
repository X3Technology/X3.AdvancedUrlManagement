                    ...
                    function () {
                        ...
                        require([
                            ...
                            require([
                                ...
                                "/DesktopModules/Admin/Dnn.PersonaBar/Modules/X3.AdvancedUrlManagement/app/controllers/host-edit.js"
                            ], function () {
                                //console.log('services and controllers loaded last');

                                // manually bootstrap the angular app 
                                angular.element(function () {
                                    angular.bootstrap(document.getElementById('X3AdvancedUrlManagementPersonaBarHost'), ['X3AdvancedUrlManagement']);
                                });
                            })
                        })
                    }
