<%@ Control Language="C#" AutoEventWireup="true" Explicit="True" Inherits="X3.AdvancedUrlManagement.HostEdit" CodeBehind="HostEdit.ascx.cs" %>

<div ng-app="X3AdvancedUrlManagement" ng-cloak>
    <div ng-controller="hostEditController">
        <div ng-form name="hostEditForm" class="form">

            <h1>Host Settings</h1>

            <p>These fields set the default URL management rules for the entire installation.  They are superceeded by rules set at the Portal level.</p>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="url_format" ng-model="host_settings.url_format">
                    <option value="advanced">Advanced (recommended)</option>
                    <option value="humanfriendly">Basic</option>
                </select>
            </div>

            <div ng-show="host_settings.url_format=='advanced'">

                <p>Use these settings to set the default rewrite and redirection rules for all websites in this DNN installation.  These rules can be superceded at the portal level.</p>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="rewritter">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="page_extension_usage" ng-model="host_settings.page_extension_usage">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group" ng-show="host_settings.page_extension_usage!='Never'">
                                    ...
                                    <input type="text" name-="page_extension" class="form-control" ng-model="host_settings.page_extension" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <switch name="force_lower_case" ng-model="host_settings.force_lower_case"></switch>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <switch name="auto_ascii_convert" ng-model="host_settings.auto_ascii_convert"></switch>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="replace_chars" class="form-control" ng-model="host_settings.replace_chars" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="replace_space_with" ng-model="host_settings.replace_space_with">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name-="replace_char_with_char" class="form-control" ng-model="host_settings.replace_char_with_char" />
                        </div>
                        ...
                        <div class="collapse" id="advancedRewrite">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="no_friendly_url_regex" class="form-control" ng-model="host_settings.no_friendly_url_regex" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="do_not_rewrite_regex" class="form-control" ng-model="host_settings.do_not_rewrite_regex" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="force_lower_case_regex" class="form-control" ng-model="host_settings.force_lower_case_regex" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="do_not_include_in_path_regex" class="form-control" ng-model="host_settings.do_not_include_in_path_regex" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="valid_extensionless_urls_regex" class="form-control" ng-model="host_settings.valid_extensionless_urls_regex" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="valid_friendly_url_regex" class="form-control" ng-model="host_settings.valid_friendly_url_regex" />
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="redirection">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <switch name="redirect_unfriendly" ng-model="host_settings.redirect_unfriendly"></switch>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <switch name="redirect_wrong_case" ng-model="host_settings.redirect_wrong_case"></switch>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <switch name="redirect_old_profile_url" ng-model="host_settings.redirect_old_profile_url"></switch>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <switch name="ssl_client_redirect" ng-model="host_settings.ssl_client_redirect"></switch>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="collapse" id="advancedRedirection">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="do_not_redirect_regex" class="form-control" ng-model="host_settings.do_not_redirect_regex" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="do_not_redirect_secure_regex" class="form-control" ng-model="host_settings.do_not_redirect_secure_regex" />
                            </div>
                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="other">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <switch name="check_for_duplicate_urls" ng-model="host_settings.check_for_duplicate_urls"></switch>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <switch name="enable_custom_providers" ng-model="host_settings.enable_custom_providers"></switch>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <switch name="log_cache_messages" ng-model="host_settings.log_cache_messages"></switch>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="collapse" id="advancedOther">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="ignore_regex" class="form-control" ng-model="host_settings.ignore_regex" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name-="use_site_urls_regex" class="form-control" ng-model="host_settings.use_site_urls_regex" />
                            </div>
                        </div>
